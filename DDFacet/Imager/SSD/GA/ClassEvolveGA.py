...
class ClassEvolveGA():
    ...
    def InitEvolutionAlgo(self):
        ...
        self.MutConfig=pFlux,p0,pMove,pScale=0.5,0.5,0.5,0.5
        toolbox.register("mutate", self.ArrayMethodsMachine.mutGaussian, pFlux=0.2, p0=0.5, pMove=0.2, pScale=0.2)
