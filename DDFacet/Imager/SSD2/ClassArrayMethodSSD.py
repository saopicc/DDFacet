...
from DDFacet.Imager.SSD2 import ClassConvMachine
import time
...
from DDFacet.Imager.SSD2.ClassParamMachine import ClassParamMachine
from DDFacet.ToolsDir.GeneDist import ClassDistMachine
from DDFacet.Imager.SSD2 import ClassMutate
...
class WorkerFitness(multiprocessing.Process):
    ...
    def runMetroSingleChain(self,individual0,NSteps=1000,chain_dict={}):
        ...
        S=self.PM.ArrayToSubArray(individual0,Type="Poly0")
