...
class TestHogbomPolClean(DDFacet.Tests.ShortAcceptanceTests.ClassCompareFITSImage.ClassCompareFITSImage):
    @classmethod
    ...
    def defineMaxSquaredError(cls):
        ...
        return [1e-6,
               ...
               [1e-6,
                1e-4,
                1e-4,
                1e-4] #epsilons per image pair, as listed in defineImageList
