...
{
  description = "ddfacet flake using uv2nix";
  ...
  outputs =
    ...
    in
    {
      ...
      packages.x86_64-linux.default = pythonSet.mkVirtualEnv "ddfacet-env" workspace.deps.default;
          ...
          let
            ...
            editablePythonSet = pythonSet.overrideScope (
              lib.composeManyExtensions [
                ...
                (final: prev: {
                  ddfacet = prev.ddfacet.overrideAttrs (old: {
