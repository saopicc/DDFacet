...
class Engine():
    ...
    def InitProberCPU(self):
        ...
        strExec="%s/HyperCal/Scripts/StartProbe.py"%self.GD.HYPERCAL_DIR
    ...
    def MapEnginesTypes(self):
        ...
        for ThisHost in hostList:
            ...
            CatEngThisNode.TypeEng[nMS:nMS+nCalc]="Calc"
            CatEngThisNode.TypeEng[nMS+nCalc:]="ProbeCPU"
...
#        PrintRecArray.Print(self.GD.CatEngines)
    ...
    def init_engines(self):
        ...
        self.DoneInit=True
        r=self.V.execute('import os; os.environ["HYPERCAL_DIR"]="%s"'%HYPERCAL_DIR); r.wait()#; print r.get()
        r=self.V.execute('sys.path=["%s"]+sys.path'%os.getcwd())
        ...
        ll=sys.path
        self.V["PYTHONPATH"]=ll
        self.V.execute('sys.path=PYTHONPATH')
