...
def main(options=None):
    ...
    if options.SplitBrightFaint:
        
        if options.SplitBrightFaintMethod=="PerFacet":
            CBF=ClassBrightFaintPerFacet(options=MaskMachine.options,
        ...
        elif options.SplitBrightFaintMethod=="Overall":
            from SkyModel.Mask.ClassBrightFaintOverAll import ClassBrightFaintOverAll
            CBF=ClassBrightFaintOverAll(options=MaskMachine.options,
                                        ImMask=MaskMachine.ImMask,
                                        Restored=MaskMachine.Restored,
                                        FitsFile=MaskMachine.FitsFile,
                                        incr_rad=MaskMachine.incr_rad)
        ...
        OutDicoModel="%s.Bright.DicoModel"%options.BaseImageName
        SkyModel.MaskDicoModel.mainFromExt(InDicoModel=InDicoModel,OutDicoModel=OutDicoModel,MaskName=ImBright,InvertMask=0)
        OutDicoModel="%s.Faint.DicoModel"%options.BaseImageName
        SkyModel.MaskDicoModel.mainFromExt(InDicoModel=InDicoModel,OutDicoModel=OutDicoModel,MaskName=ImBright,InvertMask=1)
